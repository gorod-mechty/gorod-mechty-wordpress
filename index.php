                            ...
                            <?php if ($posts) : ?>
                                <?php foreach ($posts as $post) : setup_postdata ($post); ?>
                                    <div class="projects-columns__item">
                                        ...
                                        <a class="b-link" href="<?php the_permalink() ?>"><?php echo mb_substr(get_the_title(), 0, 10) . '&hellip;'; ?></a>
                            ...
                            <?php if ($posts) : ?>
                                <?php foreach ($posts as $post) : setup_postdata ($post); ?>
                                    <div class="projects-columns__item">
                                        ...
                                        <a class="b-link" href="<?php the_permalink() ?>"><?php echo rtrim(mb_substr(get_the_title(), 0, 45)) . '&hellip;'; ?></a>
                                        <div class="text text_style_italic"><?php the_field('comment'); ?></div>
                                    </div>
                                <?php endforeach; ?>
                            <?php endif; ?>
