                            ...
                            <?php foreach ($posts as $post) : setup_postdata ($post); ?>
                                <div class="projects-columns__item">
                                    <div class="project-images clearfix ">
                                        ...
                                        ?>
                                        <a href="<?php the_permalink() ?>"><img class="b-icon projects-columns__img-l" src= <?php if (!$image_l[0]){$image_l[0] === 'bloginfo('template_url');/img/img2.png' } ?>"<?php echo $image_l[0]; ?>"/></a>
                                        <a href="<?php the_permalink() ?>"><img class="b-icon projects-columns__img-r" src= <?php if (!$image_r[0]){$image_r[0] === 'bloginfo('template_url');/img/img2.png' } ?>"<?php echo $image_r[0]; ?>"/></a>
                                    </div>
